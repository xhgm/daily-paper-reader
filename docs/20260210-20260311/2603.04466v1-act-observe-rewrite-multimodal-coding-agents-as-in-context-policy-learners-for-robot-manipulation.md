...
tags: ["query:q9"]
score: 9.0
evidence: LLM代理通过合成Python控制器代码改进机器人操作策略
...
method: 提出AOR框架，利用LLM作为智能体，根据视觉观察和任务反馈在试验间不断重写和优化底层的Python控制器代码。
result: 在三项robosuite操作任务的实验中，该方法在没有任何演示或奖励设计的情况下，依然取得了极高的任务成功率。
conclusion: 研究证明将可解释代码作为策略表示，能让LLM通过上下文学习有效地诊断并修复机器人操作中的系统性故障。
---
