...
result: 在连续控制基准和Franka机械臂实机任务中，该方法有效缩小了“仿真到现实”的差距，实现了高重复性的零样本部署。
conclusion: 通过将分布鲁棒性引入自由能框架，本研究为开发在复杂现实环境中具备高可靠性的机器人系统提供了理论支持和实践方案。
---
